...
#include <libnrarena/nr-arena-style.h>
#include <libnrarena/nr-arena-painter.h>
...
#define SP_F8_16_TO_FLOAT(v) ((float) (v) / (1 << 16))
...
void sp_style_read_from_node (SPStyle *style, TheraNode *node);
...
NRArenaStyle *sp_style_get_arena_style (SPStyle *style);
