...
#define SP_ITEM(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), SP_TYPE_ITEM, SPItem))
#define SP_IS_ITEM(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), SP_TYPE_ITEM))

#include <libnr/nr-types.h>
#include <libnrarena/nr-arena-forward.h>

#include <libsodipodi/sp-object.h>
#include <libsodipodi/print.h>
...
struct _SPItemClass {
	...
	void (* bbox) (SPItem *item, NRRectF *bbox, const NRMatrixF *transform, unsigned int flags);
	...
	void (* write_transform) (SPItem *item, TheraNode *node, NRMatrixF *transform);
...
/*
 * Requests the exact bounding box of an item
 * If flag SP_ITEM_BBOX_VISUAL current visual style is used, i.e. fill, stroke and decorations
 * Otherwise the exact bounding box of path regardless of fill state
 * If clear is TRUE bbox is cleared before invoking virtual method
 */
void sp_item_invoke_bbox (SPItem *item, NRRectF *bbox, const NRMatrixF *transform, unsigned int clear);
void sp_item_invoke_bbox_full (SPItem *item, NRRectF *bbox, const NRMatrixF *transform, unsigned int flags, unsigned int clear);
...
void sp_item_write_transform (SPItem *item, TheraNode *node, NRMatrixF *transform);
