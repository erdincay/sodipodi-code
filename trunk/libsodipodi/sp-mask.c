...
static void sp_mask_build (SPObject *object, SPDocument *document, TheraNode *node);
...
static SPObject *sp_mask_child_added (SPObject *object, TheraNode *child, TheraNode *ref);
static unsigned int sp_mask_remove_child (SPObject *object, TheraNode *child);
static void sp_mask_update (SPObject *object, SPCtx *ctx, unsigned int flags);
static void sp_mask_modified (SPObject *object, unsigned int flags);
static TheraNode *sp_mask_write (SPObject *object, TheraDocument *thedoc, TheraNode *repr, unsigned int flags);
...
static void
sp_mask_build (SPObject *object, SPDocument *document, TheraNode *node)
{
	SPMask *mask;
...
static SPObject *
sp_mask_child_added (SPObject *object, TheraNode *child, TheraNode *ref)
{
	SPMask *cp;
	SPObject *ochild;
	...
	if (((SPObjectClass *) (parent_class))->child_added)
		ochild = ((SPObjectClass *) (parent_class))->child_added (object, child, ref);
...
static unsigned int
sp_mask_remove_child (SPObject *object, TheraNode *child)
{
	SPMask *cp;
...
static TheraNode *
sp_mask_write (SPObject *object, TheraDocument *thedoc, TheraNode *repr, unsigned int flags)
{
	SPMask *cp;
	...
	if ((flags & SP_OBJECT_WRITE_BUILD) && !repr) {
		repr = thera_document_new_node (thedoc, THERA_NODE_ELEMENT, "mask");
	}
