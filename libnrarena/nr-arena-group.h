...
#define NR_ARENA_GROUP(o) (ARIKKEI_CHECK_INSTANCE_CAST ((o), NR_TYPE_ARENA_GROUP, NRArenaGroup))
#define NR_IS_ARENA_GROUP(o) (ARIKKEI_CHECK_INSTANCE_TYPE ((o), NR_TYPE_ARENA_GROUP))
...
void nr_arena_group_set_child_transform (NRArenaGroup *group, const NRMatrixF *t);
