...
#include <libsodipodiui/action.h>
...
GtkWidget *sp_button_new (unsigned int iconsize, unsigned int type, SPAction *action, void *params, GtkTooltips *tooltips);
GtkWidget *sp_button_menu_new (unsigned int iconsize, unsigned int type, unsigned int noptions, GtkTooltips *tooltips);

void sp_button_toggle_set_down (SPButton *button, unsigned int down, unsigned int signal);

void sp_button_add_option (SPButton *button, unsigned int option, SPAction *action, void *params);
unsigned int sp_button_get_option (SPButton *button);
void sp_button_set_option (SPButton *button, unsigned int option);

GtkWidget *sp_button_new_from_data (unsigned int iconsize, unsigned int type, const unsigned char *name,  const unsigned char *tip, GtkTooltips *tooltips);
