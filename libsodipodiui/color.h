...
#define SP_COLOR_U_TO_F(v) ((v) / 255.0f)
#define SP_COLOR_F_TO_U(v) ((unsigned int) ((v) * 255.9999f))
...
void sp_color_set_rgb_float (SPColor *color, float r, float g, float b, unsigned int clamp, unsigned int denorm);
void sp_color_set_rgb_rgba32 (SPColor *color, unsigned int value);

void sp_color_set_cmyk_float (SPColor *color, float c, float m, float y, float k, unsigned int clamp, unsigned int denorm);

unsigned int sp_color_get_rgba32_ualpha (const SPColor *color, unsigned int alpha);
unsigned int sp_color_get_rgba32_falpha (const SPColor *color, float alpha);
