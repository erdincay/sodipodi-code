...
static void
nr_R8G8B8A8_P_R8G8B8A8_P_R8G8B8_TRANSFORM_0 (unsigned char *px, int w, int h, int rs,
						 const unsigned char *spx, int sw, int sh, int srs,
						 const long *FFd2s, unsigned int alpha)
{
	unsigned char *d0;
...
static void
nr_R8G8B8A8_P_R8G8B8A8_P_R8G8B8_TRANSFORM_n (unsigned char *px, int w, int h, int rs,
						 const unsigned char *spx, int sw, int sh, int srs,
						 const long *FFd2s, const long *FF_S, unsigned int alpha, int dbits)
{
	int size;
						    ...
						    const NRMatrixF *d2s, unsigned int alpha, int xd, int yd)
{
	...
	if (dbits == 0) {
		nr_R8G8B8A8_P_R8G8B8A8_P_R8G8B8_TRANSFORM_0 (px, w, h, rs, spx, sw, sh, srs, FFd2s, alpha);
	} else {
		int xsize, ysize;
		long FFs_x_x_S, FFs_x_y_S, FFs_y_x_S, FFs_y_y_S;
		long FF_S[2 * 256];
		...
		nr_R8G8B8A8_P_R8G8B8A8_P_R8G8B8_TRANSFORM_n (px, w, h, rs, spx, sw, sh, srs, FFd2s, FF_S, alpha, dbits);
	}
}
