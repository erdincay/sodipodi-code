#ifndef __LIBSODIPODI_ATTRIBUTES_H__
#define __LIBSODIPODI_ATTRIBUTES_H__
...
const unsigned char *sp_attribute_name (unsigned int id);

unsigned int sp_attribute_register (unsigned int id, const unsigned char *key);
