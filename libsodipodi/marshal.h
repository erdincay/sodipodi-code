...
/* NONE:OBJECT,OBJECT,OBJECT,OBJECT (src\helper\sp-marshal.list:15) */
extern void sp_marshal_VOID__OBJECT_OBJECT_OBJECT_OBJECT (GClosure     *closure,
                                                   GValue       *return_value,
                                                   guint         n_param_values,
                                                   const GValue *param_values,
                                                   gpointer      invocation_hint,
                                                   gpointer      marshal_data);
#define sp_marshal_NONE__OBJECT_OBJECT_OBJECT_OBJECT	sp_marshal_VOID__OBJECT_OBJECT_OBJECT_OBJECT
