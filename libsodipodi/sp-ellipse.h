...
void sp_ellipse_position_set (SPEllipse * ellipse, float x, float y, float rx, float ry);
...
void sp_arc_position_set (SPArc *arc, float x, float y, float rx, float ry);
void sp_arc_get_xy (SPArc *ge, float arg, NRPointF *p);
