...
static void sp_animation_build (SPObject * object, SPDocument * document, TheraNode * node);
...
static void
sp_animation_build (SPObject *object, SPDocument *document, TheraNode *node)
{
	if (((SPObjectClass *) animation_parent_class)->build)
		((SPObjectClass *) animation_parent_class)->build (object, document, node);

	sp_object_read_attribute (object, SP_ATTR_XLINK_HREF);
	sp_object_read_attribute (object, SP_ATTR_ATTRIBUTENAME);
	sp_object_read_attribute (object, SP_ATTR_ATTRIBUTETYPE);
	sp_object_read_attribute (object, SP_ATTR_BEGIN);
	sp_object_read_attribute (object, SP_ATTR_DUR);
	sp_object_read_attribute (object, SP_ATTR_END);
	sp_object_read_attribute (object, SP_ATTR_MIN);
	sp_object_read_attribute (object, SP_ATTR_MAX);
	sp_object_read_attribute (object, SP_ATTR_RESTART);
	sp_object_read_attribute (object, SP_ATTR_REPEATCOUNT);
	sp_object_read_attribute (object, SP_ATTR_REPEATDUR);
	sp_object_read_attribute (object, SP_ATTR_FILL);
}
...
static void sp_ianimation_build (SPObject *object, SPDocument *document, TheraNode *node);
...
static void
sp_ianimation_build (SPObject *object, SPDocument *document, TheraNode *node)
{
	if (((SPObjectClass *) ianimation_parent_class)->build)
		((SPObjectClass *) ianimation_parent_class)->build (object, document, node);
...
static void sp_animate_build (SPObject * object, SPDocument * document, TheraNode * node);
...
static void
sp_animate_build (SPObject *object, SPDocument *document, TheraNode *node)
{
	if (((SPObjectClass *) animate_parent_class)->build)
		((SPObjectClass *) animate_parent_class)->build (object, document, node);
}
