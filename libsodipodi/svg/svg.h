...
unsigned int sp_svg_length_read_uff (const unsigned char *str, unsigned int *unit, float *value, float *computed);
void sp_svg_length_set (SPSVGLength *length, unsigned int unit, float value, float computed);
void sp_svg_length_unset (SPSVGLength *length, unsigned int unit, float value, float computed);
void sp_svg_length_update (SPSVGLength *length, float em, float ex, float scale);

unsigned int sp_svg_viewbox_read (const unsigned char *str, SPSVGViewBox *viewbox);
...
NRPath *sp_svg_read_path (const unsigned char *str);
unsigned char *sp_svg_write_path (const NRPath *path);
