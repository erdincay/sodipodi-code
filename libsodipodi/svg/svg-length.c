...
sp_svg_length_read (const unsigned char *str, SPSVGLength *length)
{
	...
	if (!sp_svg_length_read_uff (str, &unit, &value, &computed)) return 0;
...
unsigned int
sp_svg_length_read_uff (const unsigned char *str, unsigned int *unit, float *val, float *computed)
{
...
void
sp_svg_length_set (SPSVGLength *length, unsigned int unit, float value, float computed)
{
	length->set = 1;
	length->unit = unit;
	length->value = value;
...
void
sp_svg_length_unset (SPSVGLength *length, unsigned int unit, float value, float computed)
{
	length->set = 0;
	length->unit = unit;
	length->value = value;
...
void
sp_svg_length_update (SPSVGLength *length, float em, float ex, float scale)
{
